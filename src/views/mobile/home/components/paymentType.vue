  ...
  <div>
    <div v-if="popup" class="pop_absolute_box">
      ...
      <div v-if="popup" class="popup">
        <ul class="pop_center">
          <div class="pop_tits">
          <div class="tit">{{buyorsell == 1 ? '选择支付方式' : '选择收款方式'}}</div>
          ...
          >
            <div class="item_imgs">
              <img class="center_type" :src="item.img" alt />
  ...
  data() {
    return {
      ...
      payType: [
        {
          type: "银行卡",
          img: require("@/assets/transactions/ico_bankpay.png"),
          value: 1
        },
        {
          type: "支付宝",
          img: require("@/assets/transactions/ico_alipay.png"),
          value: 3
        },
        {
          type: "微信支付",
          img: require("@/assets/transactions/ico_weixinpay.png"),
          value: 2
        }
      ]
    };
