let upperName = 'Bitbase pro'
module.exports = {
    upperName,
    lowerName: upperName.toLowerCase(),
    chineseName: '比特贝斯普柔',
    webscoket:' wss://www.kpzzhb.com/bitpro/ws-server',
    // 请求地址
    baseUrl: {
        test: '/bitpro',  // 测试环境请求地址
        prod: '/app'   // 正式环境请求地址
    },
    // 相对路径
    publicPath: {
        test: '/bitbasepro/web/',  // 测试环境
        prod: '/'   // 正式环境
    },
    source: {
        logo: {
    ...
    // 控制功能模块的开关 0-关闭 1-打开
    moduleControl: {
        routerTransactions:1, //整合收银台的买卖功能 添加首页客服 
        Serviceurl: 1, //新客服
    }   
}